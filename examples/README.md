# Cloud Counter API - Examples

This folder contains example code for using the Cloud Counter API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/counter', {
...
response = requests.get('https://api.apiverve.com/v1/counter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/counter](https://docs.apiverve.com/ref/counter)
